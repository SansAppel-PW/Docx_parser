...
import logging
from src.extractors.image_extractor import extract_images_from_xml
from src.extractors.smartart_extractor import extract_smartart_from_xml, extract_embedded_objects_from_xml
